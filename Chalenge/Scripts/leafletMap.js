...
function generatePopUp(marker) {
    return " <table>" +
        '<tr><th colspan="3">Gender</th><th colspan="6">Ages</th></tr>' +
        ' <tr>'+
        '<td>Male</td>'+
        '<td>Female</td>' +
        '< td >Unknown</td > '+
...
markerClusters.on('clustermouseover', function (a) {
    ...
    shownLayer = a.layer;
    shownLayer.tile = "hohoho";
    polygon = L.polygon(a.layer.getConvexHull());
    map.addLayer(polygon);
    console.log("I am on cluster" + polygon);
});
...
//var myURL = jQuery('script[src$="lealetMap.js"]').attr('src').replace('leafletMap.js', '');
...
//for (var i = 0; i < markers.length; ++i) {
//   // if (markers[i].gender == 'F') {
//        //var popup = markers[i].numer +
//        //    '<br/><b>Age:</b> ' + markers[i].age +
//        //    '<br/><b>Gender:</b> ' + markers[i].gender;
...
//        m.SumF = markers[i].SumF;
//        m.SumToEighteen = markers[i].SumToEighteen;
//        m.SumEighteenTwentyFive = markers[i].SumEighteenTwentyFive;
//        m.SumTwentySixThirtyFive = markers[i].SumTwentySixThirtyFive;
//        m.SumThirtySixFourtyFive = markers[i].SumThirtySixFourtyFive;
//        m.SumFourtySixSixtyFive = markers[i].SumFourtySixSixtyFive;
//        m.SumOverSixstySix = markers[i].SumOverSixstySix;
